package br.fernando.controlekm0.dao;
...
import br.fernando.controlekm0.database.DatabaseHelper;
import br.fernando.controlekm0.dominio.Km;
import br.fernando.controlekm0.dominio.Manutencao;
import br.fernando.controlekm0.dominio.TrocaOleo;
import br.fernando.controlekm0.dominio.Usuario;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import static br.fernando.controlekm0.database.DatabaseHelper.DATABASE_TABLE;
import static br.fernando.controlekm0.database.DatabaseHelper.DATABASE_TABLE_MANUTENCAO;
import static br.fernando.controlekm0.database.DatabaseHelper.DATABASE_TABLE_TROCA_OLEO;
import static br.fernando.controlekm0.database.DatabaseHelper.DATABASE_TABLE_USERS;
import static br.fernando.controlekm0.database.DatabaseHelper.DATA_MANUTENCAO;
import static br.fernando.controlekm0.database.DatabaseHelper.DATA_TROCA_OLEO;
import static br.fernando.controlekm0.database.DatabaseHelper.DISTANCIA_MANUTENCAO;
import static br.fernando.controlekm0.database.DatabaseHelper.ID_MANUTENCAO;
import static br.fernando.controlekm0.database.DatabaseHelper.ID_TROCA_OLEO;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_DATA;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_FUNCAO;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_GERENCIA;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_ID_USERS;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_ITINERARIO;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_KM_FINAL;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_KM_INICIAL;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_KM_TOTAL;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_NOME;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_PLACA;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_QTD_CLIENTE;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_ROWID;
import static br.fernando.controlekm0.database.DatabaseHelper.KEY_UNIDADE;
import static br.fernando.controlekm0.database.DatabaseHelper.KM_MANUTENCAO;
import static br.fernando.controlekm0.database.DatabaseHelper.KM_PROXIMA_MANUTENCAO;
import static br.fernando.controlekm0.database.DatabaseHelper.KM_PROXIMA_TROCA;
import static br.fernando.controlekm0.database.DatabaseHelper.KM_TROCA_OLEO;
import static br.fernando.controlekm0.database.DatabaseHelper.VIDA_UTIL_OLEO;
